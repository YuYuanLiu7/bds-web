  ...
  return (
    <div className="min-h-[70vh] flex items-center justify-center bg-gradient-to-b from-slate-50 to-slate-100 px-6 py-20">
      <div className="max-w-md w-full text-center space-y-6">
        <div className="w-20 h-20 mx-auto rounded-2xl bg-[var(--brand)]/10 flex items-center justify-center text-[var(--brand)]">
          <Compass className="w-10 h-10" />
        </div>
        <div className="space-y-2">
          <p className="text-5xl font-black text-[var(--brand)] tracking-tight">404</p>
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center pt-2">
          <Link
            href="/"
            className="inline-flex items-center justify-center gap-2 bg-[var(--brand)] hover:opacity-90 text-white px-6 py-3 rounded-xl text-sm font-bold transition active:scale-95"
          >
